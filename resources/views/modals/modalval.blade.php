<div wire:ignore.self class="modal fade"  style="border-radius: 60px 60px 60px 60px;" id="valpedidos" tabindex="-1" role="dialog"  aria-labelledby="valpedidos" aria-hidden="true" >
...
<div class="modal-footer">
    ...
    <button class="form-control"type="button" data-bs-dismiss="modal" style="border-radius: 60px 60px 60px 60px;" id="val">No</button>
</div>
</div>
</div>
</div>