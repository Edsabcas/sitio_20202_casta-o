  ...
  <!-- One "tab" for each step in the form: -->
          ...
          <h2 style="text-align:center;">Validación Proceso Pre-Inscripción</h2>
            ...
            <div class="form-group col-xs-12">
                <label for="email"  style="font-size: 15px; color:#0a0a0a;">No. Gestión:</label><br>
                <input class="form-control me-2 input100"id='text'name="gestion"type="email"class="validate"required>
            </div>

            <div class="form-group col-xs-12">
                <label for="email"  style="font-size: 15px; color:#0a0a0a;">Dpi: </label><br>
                <input class="form-control me-2 input100"id='text'name="dpi_encargado"type="number"class="validate" required>
            </div>

            <div class="form-group col-xs-12">
                <label for="email"  style="font-size: 15px; color:#0a0a0a;">Fecha Nacimiento Encargado:</label><br>
