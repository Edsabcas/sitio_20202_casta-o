                ...
                <a href="/Descargar_constancia" type="button" class="btn btn-primary" wire:click="ver_form_ins('1')" >
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            ...
                            <p>Rellene y envie su contrato</p>
                            <div class="col-sm-12">
                                <label for="exampleInputPassword1" class="form-label " style="font-size:20px">Adjunte su contrato</label>
