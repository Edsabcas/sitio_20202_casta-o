                    ...
                    <div class="modal-body"> 
                      ...
                      <div class="container">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md">
                            <label for="metodo"><h5 style="color: #3a3e7b"><strong>MÉTODO DE PAGO</strong></h5></label>
                        ...
                        @if ($metodo==1)
                              ...
                              @if ($fpago==1)
                                  ...
                                  <div class="card text-center">      
                                    <div class="card-body">
                                      ...
                                      <p class="card-text">Q. {{$monto_ins+($monto_men)}}</p>
                                    </div>
                                  </div>                              
                              ...
                              @elseif($fpago==3)
                                  ...
                                  <div class="card text-center">      
                                    <div class="card-body">
                                      <h5 class="card-title"><strong>Total a pagar:</strong></h5>
                                      <p class="card-text">Q. {{$monto_ins+($monto_men)+($cuota_r)}}</p>
                                    </div>
                                  </div>
                              ...
                              @elseif($fpago==4)
                                  ...
                                  <div class="card text-center">      
                                    <div class="card-body">
                                      <h5 class="card-title"><strong>Total a pagar:</strong></h5>
                                      <p class="card-text">Q. {{$monto_ins+($cuota_r)}}</p>
                                    </div>
                                  </div>
                            ...
                            <div class="col-md">
                              ...
                              <div class="mb-3">
                                ...
                                @if($tipo==1)
                                  <h3 class="form-label">Visualización de la Imagen</h3>
                                  <img src="{{$archivo_comprobante->temporaryURL()}}" height="50" weight="50"  alt="...">
                                @endif
                                @if($tipo==2)
                                <h3 class="form-label">Visualización del PDF</h3>
                                <iframe width="400" height="400" src="/images/temporalpdf/{{$img}}" frameborder="0"></iframe>
                                @endif
                                @if($tipo==3)
                                <h3 class="form-label">Visualización del Documento</h3>
                                <iframe width="400" height="400" src="/images/comprobantes2022/{{$img}}" frameborder="0"></iframe>
                                @endif
                                            @if($mensaje24 != null)
