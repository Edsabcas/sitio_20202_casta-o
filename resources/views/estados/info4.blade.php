                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <li style=" opacity: 0.8;">
                                            ...
                                            <div class="timeline-panel">
                                                ...
                                                <div class="timeline-body">
                                                    ...
                                                    <br>                  
                                                    <p><strong style="font-size: 12px;">Su pago ha sido realizado correctamente.</strong></p>
                                                </div>
                                            </div>
                                        </li>
                                        <div class="d-flex justify-content-center">
                                        ...
                                        <li class="timeline text-center" style=" opacity: 0.8;">
                                            ...
                                            <div class="timeline-panel text-center">
                                                <div class="timeline-heading">
                                                    <h4 style="color: #3a3e7b"><strong>4. REGISTRO DE DATOS DE INSCRIPCIÓN | VALIDACIÓN</strong></h4>
                                                </div>
                                                <div class="timeline-body">
                                                    ...
                                                    <br> 
                                                    <br>                       
                                                    <p><strong>Los datos enviados se encuentran en proceso de validación.</strong></p>
                                                </div>
                                            </div>
                                        </li>                                
                                            </li>
